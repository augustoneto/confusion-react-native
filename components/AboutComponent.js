        ...
        const renderLeaderItem = ({item, index}) => {
            ...
            return (
                    <ListItem
                        ...
                        hideChevron={true}
                        onPress={() => navigate('Dishdetail', { leaderId: item.id })}
        ...
        return(
            <ScrollView>
                ...
                featuredTitle="Our History">
                    ...
                    Featuring four of the best three-star Michelin chefs in the world, you never know what will arrive on your plate the next time you visit us.</Text>
